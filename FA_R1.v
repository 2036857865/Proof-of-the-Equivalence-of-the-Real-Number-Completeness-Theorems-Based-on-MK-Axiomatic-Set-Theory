...
Proof.
  intros. destruct (FAT41 H H0) as [H3 | [H3 | H3]]; auto.
  - apply (@FAT72b x y z) in H3; auto. FordF.
  - apply (@FAT72c x y z) in H3; auto. FordF.
Qed.
...
Proof.
  intros. destruct (FAT41 H H0) as [H3 | [H3 | H3]]; auto.
  - apply (@FAT72a x y z) in H3; auto. FordF.
  - apply (@FAT72c x y z) in H3; auto. FordF.
Qed.
...
Proof.
  ...
  - split.
    + red. intros. appA2H H9; appA2H H10. destruct H11,H12.
      eapply (@FAT45 f0 f3 f1 f2); auto. t38. t38.
    + red. intros. appA2H H9; appA2H H10. destruct H11,H12.
...
Proof.
  ...
  assert ((f1 · f2) · f3 ~ f1 · (f2 · f3))%FC.
  { apply FAT70; auto. }
  apply (@FAT39 f (f12 · f3)%FC ((f1 · f2) · f3))%FC in H29; auto. 
  apply (@FAT39 f ((f1 · f2) · f3)%FC (f1 · (f2 · f3))%FC) in H29; auto. 
  apply (@FAT39 f0 (f1 · f23)%FC (f1 · (f2 · f3))%FC) in H30; auto.
  apply FAT38 in H30. 
  apply (@FAT39 f (f1 · (f2 · f3))%FC f0); auto.
Qed.
...
Proof.
  ...
  apply (@FAT39 f0 (f1 · fyz)%FC (f1 · (f2 + f3))%FC) in H29; auto. 
  apply (@FAT39 f0 (f1 · (f2 + f3))%FC (f1 · f2 + f1 · f3)%FC) in H29; auto. 
  apply (@FAT39 f0 (f1 · f2 + f1 · f3)%FC ((f12 + f13))%FC) in H29; auto. 
  assert ((f12 + f13) ~ f)%FC. t38.
  apply (@FAT39 f0 ((f12 + f13))%FC f) in H29; auto.
Qed.
...
Proof.
  ...
  apply (@FAT44 (f1 · f3)%FC (f2 · f4)%FC f13 f24); auto. t38. t38.
Qed.
...
Proof.
  ...
  eapply (@FAT45 (f3 · [(f4) ², (f4) ¹])%FC ([One, One])%FC f1 f2); auto. 
  t38. t38.
Qed.
